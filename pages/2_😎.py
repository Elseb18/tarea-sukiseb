...
#en esta parte del codigo se genera el titulo y las opciones del usuario
st.title("¿Quieres saber que edad tiene tu mascota? (años humanos)")
mascota = st.radio(
        "Escoge tu mascota👇",
        ["Perro", "Gato", "No tengo :("])

#en esta parte del codigo se hace que al saber la opcion del usuario nos muestra ciertos resultados
if mascota == "Perro":
